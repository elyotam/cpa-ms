...
(function () {
  ...
  var DATA = {
    ...
    ni: {                       // ביטוח לאומי ומס בריאות, עצמאי
      ...
      lowRate: 0.077,
      highRate: 0.18,
      maxIncome: 622920         // תקרת הכנסה מבוטחת: 51,910 ש"ח לחודש, החל מ-1.1.2026.
                                // אומת מול לוח השיעורים של הביטוח הלאומי (לעצמאים):
                                // מדרגה ראשונה 4.47%+3.23%=7.7%, שנייה 12.83%+5.17%=18%
    },
